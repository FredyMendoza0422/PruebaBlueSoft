...
export class AutorComponent implements OnInit {
  ...
  LoadForm() {
    this.columnDefs = [
      ...
      { headerName: 'Apellido', field: 'Apellidos',  filter: true },
      { headerName: 'Fecha Nacimiento', field: 'FechaNacimiento',  filter: true },
      ];
...
Guardar() {
    try {
      if (this.frm.valid) {
        ...
        this.Autor.Apellidos = this.frm.controls.Apellidos.value;
        this.Autor.FechaNacimiento = this.frm.controls.Fecha.value;
        this.spinner.show();
  ...
  EditarCell = (fila) => {
    ...
    if (fila) {
      ...
      this.frm.controls.Apellidos.setValue(fila.Apellido);
